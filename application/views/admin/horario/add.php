				...
				<div class="logo">
					...
					<div class="panel panel-default">   
	        			<div class="panel-heading">
	        				<h3 class="text-warning">Agregar Horarios</h3>
	        			</div>
						<div id="frm_register">				
							<form class="form-horizontal" role="form" method="post">								  
							  	<div class="form-group">
							    	<div class="col-lg-10">
							      		<input type="time" class="form-control" id="" name="hora-inicio" placeholder="HORA INICIO" value="<?php echo set_value('hora-inicio') ?>">
							    	</div>
							  	</div>
							  	<div class="form-group">
							    	<div class="col-lg-10">
							      		<input type="time" class="form-control" id="" name="hora-fin" placeholder="HORA FIN" value="<?php echo set_value('hora-fin') ?>">
							    	</div>
							  	</div>
							  	<div class="form-group">
							    	<div class="col-lg-10">
						                ...
						                <input type="hidden" class="form-control" id="id-horario" name="id-horario" value="0">
							    	</div>
							  	</div>				
							  	<div class="form-group">
							    	<div class="col-lg-6">
