						...
						<div class="col-md-4">
							<form class="navbar-form navbar-right" role="search">
							  	<div class="form-group">
							    	<input type="text" class="form-control" placeholder="Buscar Matricula">
							  	</div>
							  		...
							  		<div class="tab-pane active" id="prim-a">
								  		<table class="table table-striped">
											...
											<tr>
												...
												<td>					
													<a href="<?php echo base_url(); ?>Empleado/lstMat/<?php echo $key->no_identificacion; ?>" type='button' class='btn btn-sm btn-warning' data-toggle="tooltip" data-placement="left" data-original-title="CONSULTAR">
														<span class='glyphicon glyphicon-eye-open'></span>
													</a>
													<a href="<?php echo base_url(); ?>Empleado/updMat/<?php echo $key->no_identificacion; ?>" type='button' class='btn btn-sm btn-warning' data-toggle="tooltip" data-placement="bottom" data-original-title="MODIFICAR">
														<span class='glyphicon glyphicon-cog'></span>
													</a>													
													<a href="<?php echo base_url(); ?>" type='button' class='btn btn-sm btn-danger btn-delete' data-id="<?php echo $key->no_identificacion; ?>" data-rol="matricula" data-toggle="tooltip" data-placement="right" data-original-title="ELIMINAR">
				  				...
				  				<div class="tab-content grupos">
								  	...
								  	<div class="tab-pane" id="sext-b">
								  		<table class="table table-striped">
											...
											<tr>
												<td><?php echo $key->codigo_matriculacodigo_matricula; ?></td>
												<td><?php echo $key->fecha_matricula; ?></td>
												<td><?php echo $key->no_identificacion; ?></td>						
												<td>					
													<a href="<?php echo base_url(); ?>Empleado/lstMat/<?php echo $key->no_identificacion; ?>" type='button' class='btn btn-sm btn-warning' data-toggle="tooltip" data-placement="left" data-original-title="CONSULTAR">
